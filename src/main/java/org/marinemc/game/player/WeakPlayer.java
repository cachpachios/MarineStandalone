...
public class WeakPlayer implements IPlayer{
	...
	/**
	 * Get the UID of the referenced player
	 * If players is disconnected, return -1.
	 * @return The uid
	 */
	public short getUID() {
		if(isReferenceAlive())
	...
	/**
	 * Get the UUID of the referenced player
	 * If players is disconnected, return the uuid of Steve.
	 * @return The uuid
 	 */
	public UUID getUUID() {
		if(isReferenceAlive())
			...
			return UUID.fromString("ec561538-f3fd-461d-aff5-086b22154bce"); // Retrives the uuid of 'Alex'
	}
	
	/**
	 * Get the username of the referenced player
	 * If players is disconnected, return the uuid of Steve.
	 * @return The username
	 */
	...
	/**
	 * Returns the client if the referenced player exists in memory,
