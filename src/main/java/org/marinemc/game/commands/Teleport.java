...
public class Teleport extends Command {
	...
	public void execute(final CommandSender sender, final String[] args) {
		...
		try {
			player.teleport(getRelative(player.getLocation(), args[0], args[1],
					args[2]));
	...
	private Location getRelative(final Location location, final String x,
			final String y, final String z) throws NumberFormatException {
		// ~, ~-
		if (x.startsWith("~-"))
